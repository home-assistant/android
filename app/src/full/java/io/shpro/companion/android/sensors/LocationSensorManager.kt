...
import io.shpro.companion.android.common.bluetooth.BluetoothUtils
...
import io.shpro.companion.android.common.data.integration.containsWithAccuracy
...
import io.shpro.companion.android.database.AppDatabase
import io.shpro.companion.android.database.location.LocationHistoryItem
import io.shpro.companion.android.database.location.LocationHistoryItemResult
import io.shpro.companion.android.database.location.LocationHistoryItemTrigger
...
import io.shpro.companion.android.database.sensor.SensorSettingType
import io.shpro.companion.android.database.sensor.toSensorWithAttributes
import io.shpro.companion.android.location.HighAccuracyLocationService
import io.shpro.companion.android.notifications.MessagingManager
...
class LocationSensorManager : BroadcastReceiver(), SensorManager {
    ...
    companion object {
        ...
        const val ACTION_REQUEST_LOCATION_UPDATES =
            "io.shpro.companion.android.background.REQUEST_UPDATES"
        const val ACTION_REQUEST_ACCURATE_LOCATION_UPDATE =
            "io.shpro.companion.android.background.REQUEST_ACCURATE_UPDATE"
        const val ACTION_PROCESS_LOCATION =
            "io.shpro.companion.android.background.PROCESS_UPDATES"
        const val ACTION_PROCESS_HIGH_ACCURACY_LOCATION =
            "io.shpro.companion.android.background.PROCESS_HIGH_ACCURACY_UPDATES"
        const val ACTION_PROCESS_GEO =
            "io.shpro.companion.android.background.PROCESS_GEOFENCE"
        const val ACTION_FORCE_HIGH_ACCURACY =
            "io.shpro.companion.android.background.FORCE_HIGH_ACCURACY"
    ...
    private suspend fun getZones(serverId: Int, forceRefresh: Boolean = false): Array<Entity<ZoneAttributes>> {
        if (
            ...
            try {
                ...
                Log.e(TAG, "Error receiving zones from SH Pro", e)
