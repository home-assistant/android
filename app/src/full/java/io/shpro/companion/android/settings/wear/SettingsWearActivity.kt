...
import io.shpro.companion.android.databinding.ActivitySettingsWearBinding
import io.shpro.companion.android.settings.HelpMenuProvider
import io.shpro.companion.android.settings.wear.views.SettingsWearMainView
...
class SettingsWearActivity : AppCompatActivity(), CapabilityClient.OnCapabilityChangedListener {
    ...
    companion object {
        ...
        private const val PLAY_STORE_APP_URI =
            "market://details?id=io.shpro.companion.android"
