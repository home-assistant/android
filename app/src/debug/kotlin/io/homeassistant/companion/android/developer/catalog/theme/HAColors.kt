...
class HAColorScheme(
    ...
    fun buttonColorsFromVariant(variant: ButtonVariant): ButtonColors {
        return when (variant) {
            ...
            ButtonVariant.NEUTRAL -> TODO()
            ButtonVariant.DANGER -> TODO()
            ButtonVariant.WARNING -> TODO()
            ButtonVariant.SUCCESS -> TODO()
        }
    }
}
