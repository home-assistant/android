 ...
 *
 * Session management is driven through [MediaControlsRepository.observeEntities] flow
...
class HaMediaSessionServiceTest {
    ...
    fun setUp() {
        ...
        service.mediaControlsRepository = mediaControlsRepository
    ...
    private fun uniqueConfig(): MediaControlsEntityConfig {
        val id = sessionCounter.incrementAndGet()
        return MediaControlsEntityConfig(serverId = 1, entityId = "media_player.test_$id")
    }
