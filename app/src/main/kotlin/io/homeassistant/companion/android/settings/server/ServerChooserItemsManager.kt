 ...
 * [ServerUserAvatarRepository]) and flags the currently active server. Resolution happens concurrently
 ...
 */
class ServerChooserItemsManager @Inject constructor(
    private val serverManager: ServerManager,
    private val serverUserAvatarRepository: ServerUserAvatarRepository,
) {
    ...
    private suspend fun Server.toChooserItem(isActive: Boolean): ServerChooserItem = ServerChooserItem(
        ...
        userAvatar = serverUserAvatarRepository.getUserAvatar(id),
        isActive = isActive,
    )
}
