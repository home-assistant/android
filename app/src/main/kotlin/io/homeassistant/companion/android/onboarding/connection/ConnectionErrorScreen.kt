...
/**
 * Connection error screen for the onboarding flow.
 *
 * Uses the shared [ConnectionErrorScreen] with a close action specific to onboarding.
 *
 * @param stateProvider The provider of connection error state (typically [ConnectionViewModel])
 * @param onOpenExternalLink Callback when an external link should be opened
 * @param onCloseClick Callback when the close/back button is clicked
