...
@AndroidEntryPoint
class MediaControlsSettingsFragment : Fragment() {
    private val viewModel: MediaControlsSettingsViewModel by viewModels()

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return ComposeView(requireContext()).apply {
            setContent {
                HATheme {
                    MediaControlsSettingsScreen(viewModel = viewModel)
                }
            }
        }
    }
