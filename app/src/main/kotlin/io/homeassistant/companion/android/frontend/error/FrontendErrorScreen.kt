...
/**
 * Connection error screen that observes state from a [FrontendErrorStateProvider].
 *
 * @param stateProvider The provider of connection error state (typically a ViewModel)
                ...
                withLink(
                    LinkAnnotation.Url(
                        ...
                        linkInteractionListener = {
                            onOpenExternalLink(urlString.toUri())
                        },
                    ),
                ) {
                    append(urlString)
    ...
    Row {
        HAIconButton(
            ...
            contentDescription = stringResource(
                commonR.string.connection_error_documentation_content_description,
            ),
            onClick = {
        ...
        HAIconButton(
            ...
            contentDescription = stringResource(
                commonR.string.connection_error_forum_content_description,
            ),
            onClick = {
        ...
        HAIconButton(
            ...
            contentDescription = stringResource(
                commonR.string.connection_error_github_content_description,
            ),
            onClick = {
        ...
        HAIconButton(
            ...
            contentDescription = stringResource(
                commonR.string.connection_error_discord_content_description,
            ),
            onClick = {
