package io.shpro.companion.android.websocket
...
import io.shpro.companion.android.common.util.CHANNEL_WEBSOCKET
import io.shpro.companion.android.common.util.CHANNEL_WEBSOCKET_ISSUES
...
class WebsocketManager(
    ...
    private suspend fun createNotification(): Boolean {
        ...
        val notification = NotificationCompat.Builder(applicationContext, CHANNEL_WEBSOCKET)
            ...
            .addAction(
                io.shpro.companion.android.R.drawable.ic_websocket,
