...
import io.shpro.companion.android.common.data.integration.canSupportPrecision
import io.shpro.companion.android.common.data.integration.friendlyState
import io.shpro.companion.android.common.data.integration.onEntityPressedWithoutState
...
import io.shpro.companion.android.util.getAttribute
...
class EntityWidget : BaseWidgetProvider() {
    ...
    companion object {
        ...
        internal const val TOGGLE_ENTITY =
            "io.shpro.companion.android.widgets.entity.EntityWidget.TOGGLE_ENTITY"
