...
import io.shpro.companion.android.common.data.integration.ControlsAuthRequiredSetting
import io.shpro.companion.android.common.data.integration.Entity
import io.shpro.companion.android.common.data.integration.applyCompressedStateDiff
...
import io.shpro.companion.android.util.RegistriesDataHandler
                    ...
                    ?.collect { event ->
                        ...
                        if (!sentInitial) {
                            ...
                            (entityIds - entities.keys).forEach { missingEntity ->
                                Log.e(TAG, "Unable to get $missingEntity from SH Pro, not returned in subscribe_entities.")
                ...
                webSocketScope.launch { // using launch to create controls async
                    ...
                    try {
                        ...
                        if (entity != null) {
                            ...
                            Log.e(TAG, "Unable to get $entityId from SH Pro, null response.")
                        }
                    } catch (e: Exception) {
                        Log.e(TAG, "Unable to get $entityId from SH Pro, caught exception.", e)
