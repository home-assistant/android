...
import io.shpro.companion.android.common.data.prefs.PrefsRepository
import io.shpro.companion.android.common.data.servers.ServerManager
import io.shpro.companion.android.common.notifications.DeviceCommandData
import io.shpro.companion.android.common.notifications.NotificationData
import io.shpro.companion.android.common.notifications.clearNotification
import io.shpro.companion.android.common.notifications.commandBeaconMonitor
import io.shpro.companion.android.common.notifications.commandBleTransmitter
import io.shpro.companion.android.common.notifications.createChannelID
import io.shpro.companion.android.common.notifications.getGroupNotificationBuilder
import io.shpro.companion.android.common.notifications.handleChannel
import io.shpro.companion.android.common.notifications.handleColor
import io.shpro.companion.android.common.notifications.handleDeleteIntent
import io.shpro.companion.android.common.notifications.handleSmallIcon
import io.shpro.companion.android.common.notifications.handleText
import io.shpro.companion.android.common.notifications.parseColor
import io.shpro.companion.android.common.notifications.parseVibrationPattern
import io.shpro.companion.android.common.notifications.prepareText
import io.shpro.companion.android.common.util.cancelGroupIfNeeded
import io.shpro.companion.android.common.util.getActiveNotification
import io.shpro.companion.android.common.util.tts.TextToSpeechClient
import io.shpro.companion.android.common.util.tts.TextToSpeechData
...
import io.shpro.companion.android.database.settings.WebsocketSetting
import io.shpro.companion.android.sensors.LocationSensorManager
import io.shpro.companion.android.sensors.NotificationSensorManager
import io.shpro.companion.android.sensors.SensorReceiver
import io.shpro.companion.android.settings.SettingsActivity
import io.shpro.companion.android.util.FlashlightHelper
import io.shpro.companion.android.util.PermissionRequestMediator
import io.shpro.companion.android.util.UrlUtil
import io.shpro.companion.android.vehicle.HaCarAppService
import io.shpro.companion.android.websocket.WebsocketManager
