package io.shpro.companion.android.settings.developer
...
import io.shpro.companion.android.settings.developer.location.LocationTrackingFragment
import io.shpro.companion.android.settings.log.LogFragment
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<Preference>("show_share_logs")?.setOnPreferenceClickListener {
            parentFragmentManager.commit {
                ...
                addToBackStack(getString(io.shpro.companion.android.common.R.string.log))
            }
        ...
        findPreference<Preference>("location_tracking")?.let {
            ...
            it.setOnPreferenceClickListener {
                parentFragmentManager.commit {
                    ...
                    addToBackStack(getString(io.shpro.companion.android.common.R.string.location_tracking))
                }
                return@setOnPreferenceClickListener true
            }
        }
