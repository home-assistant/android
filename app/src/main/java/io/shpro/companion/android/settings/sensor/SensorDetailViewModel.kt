package io.shpro.companion.android.settings.sensor
...
import io.shpro.companion.android.sensors.LastAppSensorManager
...
class SensorDetailViewModel @Inject constructor(
    ...
    private val zones by lazy {
        Log.d(TAG, "Get zones from SH Pro for listing zones in preferences...")
        runBlocking {
            ...
            Log.d(TAG, "Successfully received " + cachedZones.size + " zones (" + cachedZones + ") from SH Pro")
            cachedZones
        }
    }
