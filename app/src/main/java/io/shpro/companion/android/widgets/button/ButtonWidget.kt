...
import io.shpro.companion.android.widgets.common.WidgetAuthenticationActivity
...
class ButtonWidget : AppWidgetProvider() {
    companion object {
        ...
        const val CALL_SERVICE =
            "io.shpro.companion.android.widgets.button.ButtonWidget.CALL_SERVICE"
        private const val CALL_SERVICE_AUTH =
            "io.shpro.companion.android.widgets.button.ButtonWidget.CALL_SERVICE_AUTH"
        internal const val RECEIVE_DATA =
            "io.shpro.companion.android.widgets.button.ButtonWidget.RECEIVE_DATA"
        ...
        mainScope.launch {
            ...
            if (domain == null || action == null || actionDataJson == null) {
                ...
                try {
                    ...
                    Log.d(TAG, "Sending action call to SH Pro")
