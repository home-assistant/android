...
val previewEntity1 = Entity("light.first", "on", lightAttributes, calendar, calendar)
val previewEntity2 = Entity("light.second", "off", attributes, calendar, calendar)
val previewEntity3 = Entity("scene.first", "on", attributes, calendar, calendar)
val previewEntity4 = Entity("fan.first", "on", fanAttributes, calendar, calendar)
...
val playPreviewEntityScene1 = Entity("scene.first", "on", mapOf("friendly_name" to "Cleaning mode"), calendar, calendar)
val playPreviewEntityScene2 = Entity("scene.second", "on", mapOf("friendly_name" to "Colorful"), calendar, calendar)
val playPreviewEntityScene3 = Entity("scene.third", "on", mapOf("friendly_name" to "Goodbye"), calendar, calendar)
