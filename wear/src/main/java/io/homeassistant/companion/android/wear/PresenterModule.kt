...
class PresenterModule {
    ...
    @Provides
    fun provideActionsView() = actionsView
    @Provides
    fun provideCreateActionView() = actionView
    @Provides
    ...
    interface Declaration {
        ...
        @Binds
        fun bindNavigationPresenter(presenter: NavigationPresenterImpl): NavigationPresenter
        @Binds
        fun bindActionsPresenter(presenter: ActionsPresenterImpl): ActionsPresenter
        @Binds
        fun bindCreateActionPresenter(presenter: ActionPresenterImpl): ActionPresenter
        @Binds
