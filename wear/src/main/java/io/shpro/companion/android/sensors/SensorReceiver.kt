...
import io.shpro.companion.android.common.sensors.AndroidOsSensorManager
import io.shpro.companion.android.common.sensors.AudioSensorManager
import io.shpro.companion.android.common.sensors.BatterySensorManager
import io.shpro.companion.android.common.sensors.BluetoothSensorManager
import io.shpro.companion.android.common.sensors.DNDSensorManager
import io.shpro.companion.android.common.sensors.DisplaySensorManager
import io.shpro.companion.android.common.sensors.KeyguardSensorManager
import io.shpro.companion.android.common.sensors.LastRebootSensorManager
import io.shpro.companion.android.common.sensors.LastUpdateManager
import io.shpro.companion.android.common.sensors.LightSensorManager
import io.shpro.companion.android.common.sensors.MobileDataManager
import io.shpro.companion.android.common.sensors.NetworkSensorManager
import io.shpro.companion.android.common.sensors.NextAlarmManager
import io.shpro.companion.android.common.sensors.NfcSensorManager
import io.shpro.companion.android.common.sensors.PhoneStateSensorManager
import io.shpro.companion.android.common.sensors.PowerSensorManager
import io.shpro.companion.android.common.sensors.PressureSensorManager
import io.shpro.companion.android.common.sensors.ProximitySensorManager
import io.shpro.companion.android.common.sensors.SensorManager
import io.shpro.companion.android.common.sensors.SensorReceiverBase
import io.shpro.companion.android.common.sensors.StepsSensorManager
import io.shpro.companion.android.common.sensors.StorageSensorManager
import io.shpro.companion.android.common.sensors.TimeZoneManager
import io.shpro.companion.android.common.sensors.TrafficStatsManager
import io.shpro.companion.android.home.HomeActivity
import io.shpro.companion.android.home.views.DEEPLINK_SENSOR_MANAGER
...
class SensorReceiver : SensorReceiverBase() {
    ...
    companion object {
        ...
        const val ACTION_REQUEST_SENSORS_UPDATE =
            "io.shpro.companion.android.background.REQUEST_SENSORS_UPDATE"
