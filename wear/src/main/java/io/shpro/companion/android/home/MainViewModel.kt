    ...
    private fun loadSettings() {
        viewModelScope.launch {
            ...
            val assistantAppComponent = ComponentName(
                ...
                "io.shpro.companion.android.conversation.AssistantActivity"
            )
