package io.shpro.companion.android.phone
...
import io.shpro.companion.android.common.data.keychain.KeyStoreRepositoryImpl
import io.shpro.companion.android.common.data.prefs.WearPrefsRepository
...
import io.shpro.companion.android.common.util.WearDataMessages
import io.shpro.companion.android.database.server.Server
import io.shpro.companion.android.database.server.ServerConnectionInfo
import io.shpro.companion.android.database.server.ServerSessionInfo
import io.shpro.companion.android.database.server.ServerType
...
import io.shpro.companion.android.database.wear.getAll
import io.shpro.companion.android.database.wear.replaceAll
import io.shpro.companion.android.home.HomeActivity
import io.shpro.companion.android.home.HomePresenterImpl
import io.shpro.companion.android.onboarding.getMessagingToken
import io.shpro.companion.android.tiles.CameraTile
import io.shpro.companion.android.tiles.ConversationTile
import io.shpro.companion.android.tiles.ShortcutsTile
import io.shpro.companion.android.tiles.TemplateTile
...
class PhoneSettingsListener : WearableListenerService(), DataClient.OnDataChangedListener {
    ...
    private fun login(dataMap: DataMap) = mainScope.launch {
        ...
        try {
            ...
            Log.e(TAG, "Unable to login to SH Pro", e)
            try {
                if (serverId != null) {
