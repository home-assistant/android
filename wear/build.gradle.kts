...
dependencies {
    ...
    implementation("androidx.wear.compose:compose-foundation:1.0.0-rc01")
    implementation("androidx.wear.compose:compose-material:1.0.0-rc01")
    implementation("androidx.wear.compose:compose-navigation:1.0.0-rc01")
