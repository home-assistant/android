...
import io.homeassistant.companion.android.common.frontend.externalbus.outgoing.ResultMessage.Companion.config
    ...
    companion object {
        ...
        fun config(id: Int?, config: ConfigResult): ResultMessage {
            return ResultMessage(
                id = id,
                result = kotlinJsonMapper.encodeToJsonElement(config),
            )
        }
    }
}
