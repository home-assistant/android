 ...
 *
 * The external bus is a communication channel between the Home Assistant frontend (PWA)
 ...
 *
 * The app should respond with an [io.homeassistant.companion.android.common.frontend.externalbus.outgoing.OutgoingExternalBusMessage] containing the capabilities.
 */
@Serializable
