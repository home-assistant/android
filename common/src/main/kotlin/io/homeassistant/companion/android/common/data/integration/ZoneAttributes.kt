 ...
 * [extraRadiusMeters] expands the zone (for example a high-accuracy trigger range).
 */
// TODO Introduce back ZoneAttribute class https://github.com/home-assistant/android/issues/5340
fun Entity.containsWithAccuracy(location: Location, extraRadiusMeters: Float = 0f): Boolean {
    ...
    return (
        location.distanceTo(zoneCenter) - (attributes["radius"] as Number).toFloat() -
            extraRadiusMeters - location.accuracy.coerceAtLeast(0f)
        ) <=
        0
}
