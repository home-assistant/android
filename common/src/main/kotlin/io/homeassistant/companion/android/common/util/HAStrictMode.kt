...
object HAStrictMode {
     ...
     *
     * If a violation is detected by the VM policy, the application will [FailFast] by default.
    ...
    fun enable(ignoredViolationRules: List<IgnoreViolationRule> = emptyList()) {
        StrictMode.setVmPolicy(
            StrictMode.VmPolicy.Builder()
                ...
                .penaltyListener(Executors.newSingleThreadExecutor()) { violation ->
                    if (!ignoredViolationRules.any { it.shouldIgnore(violation) }) {
