...
internal class NewServerManagerImpl @Inject constructor(
    ...
    override suspend fun addServer(server: Server): Int {
        // TODO something weird with temporary server type
        // Make sure the ID is not already set
        return serverDao.add(server.copy(id = 0)).toInt()
    }
