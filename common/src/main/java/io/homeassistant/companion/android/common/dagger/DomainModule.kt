...
import io.homeassistant.companion.android.common.actions.WearActionUseCaseImpl
...
interface DomainModule {
    ...
    @Binds
    fun bindWearActionsUseCase(useCase: WearActionUseCaseImpl): WearActionUseCase
}
