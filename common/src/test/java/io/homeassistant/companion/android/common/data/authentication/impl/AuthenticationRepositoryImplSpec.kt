...
object AuthenticationRepositoryImplSpec : Spek(
    {
        ...
        describe("a repository") {
            ...
            val authenticationService by memoized {
            ...
            describe("build auth url") {
                ...
                beforeEachTest {
                    coEvery { urlRepository.getUrl() } returns URL(
                        "https://demo.home-assistant.io/"
                    )
                    authenticationUrl =
                        runBlocking {
                            repository.buildAuthenticationUrl(
                ...
                it("should return the authentication url") {
                    assertThat(authenticationUrl).isEqualTo(
                        URL(
                            "https://demo.home-assistant.io/auth/authorize?response_type=code&client_id=https://home-assistant.io/android&redirect_uri=homeassistant://auth-callback"
                        )
                    )
                }
            }
            ...
            describe("connected user with valid access token") {
                ...
                describe("retrieve external authentication") {
                    ...
                    it("should serialize the external authentication saved") {
                        assertThat(externalAuth).isEqualTo(
                            "{\"access_token\":\"ABCDEFGH\",\"expires_in\":1800}"
                        )
                    }
                }
            ...
            describe("connected user with expired access token") {
                ...
                describe("retrieve external authentication") {
                    ...
                    it("should serialize the refresh external authentication") {
                        assertThat(externalAuth).isEqualTo(
                            "{\"access_token\":\"HGFEDCBA\",\"expires_in\":1800}"
                        )
                    }
                }
