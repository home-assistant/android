...
class ServerManagerImplTest {
    ...
    private val mediaControlsDao: MediaControlsDao = mockk()
    ...
    fun setup() {
        serverManager = ServerManagerImpl(
            ...
            mediaControlsDao = mediaControlsDao,
    ...
    inner class RemoveServerTest {
        ...
        fun `Given server when removeServer then cleans up all resources in order`() = runTest {
            ...
            coEvery { mediaControlsDao.deleteByServerId(serverId) } just Runs
            ...
            coVerifyOrder {
                ...
                mediaControlsDao.deleteByServerId(serverId)
